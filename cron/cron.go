...
type FuncJob func() map[string]interface{}

func (f FuncJob)Run() map[string]interface{} {
	return f()
}

func (f FuncJob)GetRetry() int {
	return 0
}
...
func (c *Cron) AddFunc(spec string, cmd func()map[string]interface{}) error {
